...
@section('custom_js')
    ...
    <script>
        ...
        $btnRegister.addEventListener('click', () => {
            ...
            $btnRegister.innerHTML = `<img src="http://website.test/img/loaderButton.svg" alt="loader" height: 20px;"> Redirecting...`;
        });

        $btnLogin.addEventListener('click', () => {
           
            $btnLogin.innerHTML = `<img src="http://website.test/img/loaderButton.svg" alt="loader" height: 20px;"> Loggin in...`;
        });
